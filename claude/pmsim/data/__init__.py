...
Two workbook layouts are supported behind one seam:
    ...
    result = run_workbook("tables.xlsx", SimulationSpec("GBP", liquid_series="liquid_gbp", fx_series="gbp_per_usd"))
...
from .workbook import SheetLayout, WorkbookRepository, commitment_schedule, load_profile_workbook, run_profile_workbook

__all__ = [
    "SimulationSpec", "Orchestrator", "build_funds", "build_portfolio", "returns_to_levels",
    "load_workbook", "run_workbook",
    "DataRepository", "ExcelRepository", "FrameRepository", "SheetNames",
    "WorkbookRepository", "SheetLayout", "commitment_schedule", "load_profile_workbook", "run_profile_workbook",
